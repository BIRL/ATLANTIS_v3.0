...
% Last Modified by GUIDE v2.5 18-Jun-2019 12:08:22
...
% --- Executes on button press in NetworkType1.
function NetworkType1_Callback(hObject, eventdata, handles)
% hObject    handle to NetworkType1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of NetworkType1
