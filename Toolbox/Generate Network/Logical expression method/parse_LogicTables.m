...
for i = 1:nodeCount
    ...
    try
        ...
        sourceNodes = lower(token3(1:end-1));
        targetNode = lower(token3(end))
        
        nodeList = lower(nodeList);
...
% myNetwork.TruthTables       = TruthTables;
